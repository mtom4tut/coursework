...
<form autocomplete="off" class="form auth" action="/admin/goods.php" method="post" enctype="multipart/form-data">
  <div class="form__group">
    ...
    <input class="form__input <?php if (isset($errors["price"])) {
                              ...
                              } ?>" type="text" name="price" id="price" value="<?= get_post_val("price") === "" ? $updateData['price'] : get_post_val("price") ?>" placeholder="Введите стоимость товара">
  ...
  <div class="form__group">
    ...
    <input class="form__input <?php if (isset($errors["title"])) {
                                print("form__input--error");
                              } ?>" type="text" name="title" id="title" value="<?= get_post_val("title") === "" ? $updateData['title'] : get_post_val("title") ?>" placeholder="Введите заголовок товара">
  ...
  <div class="form__group">
    ...
    <textarea name="description" id="description" rows="4"><?= get_post_val("description") === "" ? $updateData['description'] : get_post_val("description") ?></textarea>
  </div>
