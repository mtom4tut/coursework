...
<form class="form auth" action="/admin/vipuser.php" method="post" enctype="multipart/form-data">
  ...
  <div class="form__group">
    ...
    <input class="form__input form__input--date
            ...
            ?>" type="text" name="data_start" id="dateStart" value="<?= get_post_val("data_start") ?>" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
  ...
  <div class="form__group">
    ...
    <input class="form__input form__input--data_end
            ...
            ?>" type="text" name="data_end" id="dateEnd" value="<?= get_post_val("data_end") ?>" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
