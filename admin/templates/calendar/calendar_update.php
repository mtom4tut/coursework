<h2 class="modal__title">Изменение данных скидки</h2>
...
<form autocomplete="off" class="form auth" action="/admin/calendar.php" method="post" enctype="multipart/form-data">
  <div class="form__group">
    ...
    <input class="form__input <?php if (isset($errors["holiday"])) {
                              ...
                              } ?>" type="text" name="holiday" id="holiday" value="<?= get_post_val("holiday") === "" ? $updateData['holiday'] : get_post_val("holiday") ?>" placeholder="Введите название праздника">
  ...
  <div class="form__group">
    ...
    <input class="form__input form__input--date" type="text" name="date" id="dateSk" value="<?= get_post_val("date") === "" ? $updateData['date'] : get_post_val("date") ?>" placeholder="Введите дату в формате ММ-ДД">
  ...
  <div class="form__group">
    ...
    <input class="form__input <?php if (isset($errors["discount"])) {
                                print("form__input--error");
                              } ?>" type="text" name="discount" id="discount" value="<?= get_post_val("discount") === "" ? $updateData['discount'] : get_post_val("discount") ?>" placeholder="Введите скидку в праздник">
