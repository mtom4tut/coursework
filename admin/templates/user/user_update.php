...
<form class="form auth" action="/admin/user.php" method="post" enctype="multipart/form-data">
<div class="form__group">
    ...
    <input class="form__input <?php if (isset($errors["username"])) {
                              ...
                              } ?>" type="text" name="username" id="username" value="<?= get_post_val("username") === "" ? $updateData['username'] : get_post_val("username") ?>" placeholder="Введите имя">
  ...
  <div class="form__group">
    ...
    <input class="form__input <?php if (isset($errors["mail"])) {
                                print("form__input--error");
                              } ?>" type="text" name="mail" id="mail" value="<?= get_post_val("mail") === "" ? $updateData['mail'] : get_post_val("mail") ?>" placeholder="Введите E-Mail">
  ...
  <div class="form__group">
    ...
    <input class="form__input form__input--date
            ...
            ?>" type="text" name="birthday" id="date" value="<?= get_post_val("birthday") === "" ? $updateData['birthday'] : get_post_val("birthday") ?>" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
  ...
  <div class="form__group">
    ...
    <input class="form__input <?php if (isset($errors["password"])) {
                                print("form__input--error");
                              } ?>" type="password" name="password" id="password" value="<?= get_post_val("password") === "" ? $updateData['password'] : get_post_val("password") ?>" placeholder="Введите пароль">
